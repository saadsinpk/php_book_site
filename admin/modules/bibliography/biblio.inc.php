...
class Biblio
{
  ...
  public function getItemCopy()
  {
    $items = array();
    $_output = '';
    $copy_q = $this->db->query(sprintf('SELECT i.item_code, i.call_number, loc.location_name, ct.coll_type_name, stat.*, i.site FROM item AS i
  ...
  public function getSubjects()
  {
    $items = array();
    // get the topics data
    $_biblio_topics_q = $this->db->query(sprintf('SELECT topic, topic_type, ba.topic_id, classification, auth_list FROM mst_topic AS a
