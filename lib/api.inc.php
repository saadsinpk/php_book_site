  ...
  public static function member_load($obj_db, $member_id)
  {
    ...
    if (!$obj_db->errno) {
      ...
      while ($r_mbr = $q_mbr->fetch_assoc()) {
        ...
        $_return[$i]['member_name'] = $r_mbr['first_name'].' '.$r_mbr['last_name'];
        $_return[$i]['first_name'] = $r_mbr['first_name'];
        $_return[$i]['last_name'] = $r_mbr['last_name'];
        ...
        $_return[$i]['member_address_line'] = $r_mbr['member_address_line'];
        $_return[$i]['member_address_suburb'] = $r_mbr['member_address_suburb'];
        $_return[$i]['member_address_state'] = $r_mbr['member_address_state'];
        $_return[$i]['member_address_postal'] = $r_mbr['member_address_postal'];
