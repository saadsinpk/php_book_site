...
$message = __('Enter your details below and we\'ll send you an email with a link for resetting your password.');
...
<div id="loginForm">
    ...
    <form action="index.php?p=forgot" method="post" novalidation>
        <div class="heading1"><?php echo __('Email address:'); ?></div>
        ...
        <a class="forgotButton" href="index.php?p=admin"><?php echo __('Cancel') ?></a>
        </div>
    </form>
</div>
...
// page title
$page_title = __('Forgot your password?');
